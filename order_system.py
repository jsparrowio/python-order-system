def place_order(menu):
    ...
    while True:
        ...
        user_choice = input("Would you like to order anything else? \nNote: ensure you type 'n' or 'N' to quit: ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_selection in range(len(menu_items)):
            # Store the item name as a variable
            food_item = menu_items[menu_selection]["Item name"]

            # Ask the customer for the quantity of the menu item
            quantity = input(f"How many of {food_item} would you like? ")
            ...
            print("That menu selection was not valid!")
    else:
